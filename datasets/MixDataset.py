...
from Config import clean_pattern, noise_pattern, part_frames
...
class MixDataset(Dataset):
    def __init__(self, snr_range: tuple, steps_per_epoch, frames: int = part_frames,
        ...
        self.clean_dataset = AudioDataset(clean_pattern_, frames, steps_per_epoch, 'clean')
        print('Init noise_dataset')
        self.noise_dataset = AudioDataset(noise_pattern_, frames, steps_per_epoch, 'noise')
